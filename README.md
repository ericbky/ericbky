...
Tenho sólidos conhecimentos em Engenharia de Software, como programação web, levantamento de requisitos, metodologias ágeis, tipos de testes, estrutura de dados, banco de dados, etc.
